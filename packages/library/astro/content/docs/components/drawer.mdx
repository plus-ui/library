...
```tsx
import { PlusDrawer, PlusButton } from '@plusui/library/react';
...
import type { PlusDrawer } from '@plusui/library/components/drawer/drawer';
...
<plus-drawer id="drawer-orientation">
  <div slot="header">Orientation Example</div>
  <div slot="body">Content</div>
</plus-drawer>

<script>
  const drawerO = document.getElementById('drawer-orientation');
  document.getElementById('open-left').addEventListener('plus-click', () => {
    drawerO.orientation = 'left';
    drawerO.show();
  });
  document.getElementById('open-right').addEventListener('plus-click', () => {
    drawerO.orientation = 'right';
    drawerO.show();
  });
  document.getElementById('open-top').addEventListener('plus-click', () => {
    drawerO.orientation = 'top';
    drawerO.show();
  });
  document.getElementById('open-bottom').addEventListener('plus-click', () => {
...
<plus-drawer id="drawer-size">
  <div slot="header">Size Example</div>
  <div slot="body">Content</div>
</plus-drawer>

<script>
  const drawerS = document.getElementById('drawer-size');
  document.getElementById('open-sm').addEventListener('plus-click', () => {
    drawerS.size = 'sm';
    drawerS.show();
  });
  document.getElementById('open-md').addEventListener('plus-click', () => {
    drawerS.size = 'md';
    drawerS.show();
  });
  document.getElementById('open-lg').addEventListener('plus-click', () => {
    drawerS.size = 'lg';
    drawerS.show();
  });
</script>
...
```html
<plus-button id="open-slots">Open Custom Drawer</plus-button>

<plus-drawer id="drawer-slots">
  ...
  <div slot="footer">
    <plus-button kind="text" id="close-slots">Close</plus-button>
    <plus-button>Save</plus-button>
  </div>
  <plus-button slot="close" kind="text" aria-label="Close">
    <plus-icon iconName="xmark-large"></plus-icon>
  </plus-button>
</plus-drawer>

<script>
  const drawerSlots = document.getElementById('drawer-slots');
  document.getElementById('open-slots').addEventListener('plus-click', () => drawerSlots.show());
  document.getElementById('close-slots').addEventListener('plus-click', () => drawerSlots.hide());
...
```tsx
import { PlusDrawer, PlusButton, PlusIcon } from '@plusui/library/react';
import { useRef } from 'react';
