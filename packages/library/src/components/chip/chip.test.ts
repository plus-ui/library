...
describe('PlusChip', () => {
 describe('accessibility', () => {
   it('default is accessible', async () => {
     const el = await fixture<PlusChip>(html`<plus-chip>Default Chip</plus-chip>`);
   ...
   it('disabled state is accessible', async () => {
     const el = await fixture<PlusChip>(html`<plus-chip disabled>Disabled Chip</plus-chip>`);
   ...
   it('dismiss button is accessible', async () => {
     const el = await fixture<PlusChip>(html`<plus-chip dismiss>Dismissible Chip</plus-chip>`);
 ...
 describe('functionality', () => {
    ...
    it('does not emit dismiss event when disabled', async () => {
      const el = await fixture<PlusChip>(html`<plus-chip dismiss disabled>Disabled Dismissible Chip</plus-chip>`);
      const dismissButton = el.shadowRoot?.querySelector('plus-icon');
 ...
 describe('styling', () => {
   it('applies correct status styles', async () => {
     const el = await fixture<PlusChip>(html`<plus-chip status="success">Success Chip</plus-chip>`);
     const chipElement = el.shadowRoot?.querySelector('div');
