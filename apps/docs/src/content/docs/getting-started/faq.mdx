...
The central token system in Plus UI is a powerful feature that bridges the design system and UI library, ensuring a consistent and unified design language across a project. Tokens are essentially design variables (such as colors, [typography](/library/foundation/typography), [spacing](/library/foundation/spacing), [border](/library/foundation/border), [opacity](/library/foundation/opacity), [shadows & effects](/library/foundation/shadows-and-effects), [breakpoints](/library/foundation/breakpoints) etc.) that can be reused and applied globally. This system allows designers and developers to make changes in one place that automatically reflect across the entire project, streamlining the design process and ensuring consistency.
</details>
...
The centralized token system in Plus UI functions as a core part of the design system, where design tokens represent the visual design atoms of the product (such as colors, [typography](/library/foundation/typography), [spacing](/library/foundation/spacing), [border](/library/foundation/border), [opacity](/library/foundation/opacity), [shadows & effects](/library/foundation/shadows-and-effects), [breakpoints](/library/foundation/breakpoints) etc.) These tokens are defined in a central location and can be used across components and applications. When a token is updated, the changes are automatically applied wherever the token is used, ensuring consistency and simplifying theme management.
</details>
...
Integrating [Plus UI with Vue.js](/library/ui-library/installation/vue) involves:
...
To integrate [Plus UI with Angular](/library/ui-library/installation/angular):
