...
<CodePreview autoGeneration={true} horizontal>
  <plus-link data-variant-size="sm,md,lg" href="https://plusui.com">Link Text</plus-link>
</CodePreview>
...
<CodePreview autoGeneration={true} horizontal>
  <plus-link data-variant-underline="never,hover,always" href="https://plusui.com">Link Text</plus-link>
</CodePreview>
...
<CodePreview autoGeneration={true} horizontal>
  <plus-link data-variant-disabled="false,true">Link Text</plus-link>
</CodePreview>
...
<CodePreview autoGeneration={true}>
  <plus-link href="https://plusui.com" external>External Link (Opens in new tab)</plus-link>
</CodePreview>
