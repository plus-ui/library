...
## Styles
### Design Foundation
- [Shadows and Effects](/library/foundation/shadows-and-effects)
- [Typography](/library/foundation/typography)
- [Icons](/library/foundation/icons)

## Variables
### Design Variables
- [Border](/library/foundation/border)
- [Breakpoints](/library/foundation/breakpoints)
- Color
- [Spacing](/library/foundation/spacing)
- [Opacity](/library/foundation/opacity)
