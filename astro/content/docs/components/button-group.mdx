...
The Button Group component comprises items derived from Plus UI's [button component.](/components/button) Each item inherits the properties of the button component. For more details on the properties specific to button components, please refer to the [button documentation](/components/button). To customize the Button Group component, you can tailor the properties of its underlying button components.
