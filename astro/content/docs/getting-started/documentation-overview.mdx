...
<br /> ✓ Multi-framework Support (works wherever HTML works such as [React](/ui-library/installation/react), [Vue](/ui-library/installation/vue), [Angular](/ui-library/installation/angular), [Svelte](/ui-library/installation/svelte) and other JS frameworks)
...
## Foundations
The foundations of Plus UI guide to creating a consistent, effective, and accessible product that meets the needs of users. It helps designers and developers to work together more efficiently, reducing the risk of inconsistencies, enlightening the principles and patterns, and general solutions for specific problems. Visit the [Foundations](/foundation/overview) section for further information.
